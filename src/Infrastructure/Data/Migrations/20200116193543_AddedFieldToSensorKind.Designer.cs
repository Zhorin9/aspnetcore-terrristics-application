...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20200116193543_AddedFieldToSensorKind")]
    partial class AddedFieldToSensorKind
    {
            ...
            modelBuilder.Entity("AppCore.Entities.InputSensorData", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2020, 1, 16, 20, 35, 43, 281, DateTimeKind.Local));
            ...
            modelBuilder.Entity("AppCore.Entities.TerraristicWindow", b =>
                {
                    ...
                    b.Property<Guid>("ApiKey")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new Guid("9bec5f6c-6ff0-4bac-8d0d-e60819a5f3b3"));

                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("date")
                        .HasDefaultValue(new DateTime(2020, 1, 16, 20, 35, 43, 296, DateTimeKind.Local));
